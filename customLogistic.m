function [out,summaryArray] = customLogistic(subjectMatrix)
...
if nullDev == 0 && devH == 0
    ...
    summaryCon = table(con,[NaN,NaN,NaN,NaN,NaN,NaN,NaN]',...
        ...
        [NaN,NaN,NaN,NaN,NaN,NaN,NaN]',...
        [NaN,NaN,NaN,NaN,NaN,NaN,NaN]',...
        'VariableNames',{'Condition','Intercept','Betas','SE','Pvals','Model_deviance'});    
else
    con = {'Handling','Reward','bothH','bothR','InteractionH','InteractionR','Interaction'}'; % labels for continuous
    summaryCon = table(con,[statsH.beta(1),statsR.beta(1),stats.beta(1),0,statsInt.beta(1),0,0]',...
        [statsH.beta(2),statsR.beta(2),stats.beta(2),stats.beta(3),statsInt.beta(2),statsInt.beta(3),statsInt.beta(4)]',...
        [statsH.se(2),statsR.se(2),stats.se(2),stats.se(3),statsInt.se(2),statsInt.se(3),statsInt.se(4)]',...
...
out.nullDev = nullDev;
summaryArray = table2array(out.Summary(:,2:end));
