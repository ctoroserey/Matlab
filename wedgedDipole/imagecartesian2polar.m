...
% IMAGECARTESIAN2POLAR converts a given bidimensional graycolor image from cartesian 
% coordinates to polar coordinates according to usually B-mode ultrasounds image representation
% The input image, I(i,j), is mapped (rows->columns) to (double) polar coordinates (xx,yy)
% and then represented as a surface (I(xx,yy))
%
% Input:
