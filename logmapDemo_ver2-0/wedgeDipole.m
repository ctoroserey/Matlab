...
alpha1 = 1.00; % azimuthal shear in V1
alpha2 = 0.33; % azimuthal shear in V2
alpha3 = 0.25; % azimuthal shear in V3

ecc = 90;   % extent of visual field eccentricity
Necc = 30;  % number of steps in eccentricity
Npol = 32;  % number of steps in polar angle
...
% Claudio: this approach is reversed.
% Ideally, region=specific shear 
% wedge mapping
