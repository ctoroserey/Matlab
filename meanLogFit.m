...
meanBeta.cogIntrcpt = mean(logBetas.cogIntrcpt);
meanBeta.cogRwds = mean(logBetas.cogRwds);
meanBeta.cogHndl = mean(logBetas.cogHndl);
...
meanBeta.waitIntrcpt = mean(logBetas.waitIntrcpt);
meanBeta.waitRwds = mean(logBetas.waitRwds);
meanBeta.waitHndl = mean(logBetas.waitHndl);
...
%legend('Handling = 2s','Handling = 10s','Handling = 14s');
legend('Handling = 2s','Handling = 10s','Handling = 14s','Handling = 2s','Handling = 10s','Handling = 14s')
